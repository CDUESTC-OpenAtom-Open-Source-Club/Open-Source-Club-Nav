-- 005_normalize_seed_data.up.sql (MySQL)
-- Rebuild clean seed data from the normalized local business dataset.

-- Runtime tables should start empty. They are regenerated by real traffic,
-- login/admin actions, and link-health checks.
...
ALTER TABLE nav_item_health AUTO_INCREMENT = 1;
ALTER TABLE nav_item_logs AUTO_INCREMENT = 1;
ALTER TABLE login_audit AUTO_INCREMENT = 1;
ALTER TABLE daily_visits AUTO_INCREMENT = 1;
ALTER TABLE metrics AUTO_INCREMENT = 1;

-- Legacy resource_matrix table is kept for compatibility, but public
-- /api/resources is now derived from nav_items to avoid a third data source.
DELETE FROM resource_matrix;
ALTER TABLE resource_matrix AUTO_INCREMENT = 1;
...
ALTER TABLE mini_games AUTO_INCREMENT = 1;
ALTER TABLE nav_items AUTO_INCREMENT = 1;
ALTER TABLE users AUTO_INCREMENT = 1;

-- ============================================================
-- 管理员账号（密码均为 admin123，bcrypt 哈希）
-- ============================================================
INSERT INTO users (email, password_hash, role, status, username, password, created_at, updated_at)
VALUES
  ('admin@example.com', '$2a$10$fsoxTaSewAAg0g.FA72XWuQ6eO/kODnviKG3rjEjiT1Po6Gux/2EW', 'super', 1, 'admin', '', NOW(3), NOW(3)),
  ('editor@example.com', '$2a$10$fsoxTaSewAAg0g.FA72XWuQ6eO/kODnviKG3rjEjiT1Po6Gux/2EW', 'editor', 1, 'editor', '', NOW(3), NOW(3));

-- ============================================================
-- 统一导航内容（46 条）
-- resource_matrix: 36，friend_links: 7，mini_games: 3
-- ============================================================
...
('resource_matrix', 'think_tank', 'Brain', 'W3Schools', 'Web开发入门教程', 'Web开发入门教程', 11, 1, 'resource_matrix', '', 'https://www.w3schools.com', NOW(3), NOW(3)),
('resource_matrix', 'think_tank', 'Brain', '菜鸟教程', '编程语言入门指南', '编程语言入门指南', 12, 1, 'resource_matrix', '', 'https://www.runoob.com', NOW(3), NOW(3)),
...
('resource_matrix', 'tools', 'Wrench', 'Figma', 'UI/UX设计协作工具', 'UI/UX设计协作工具', 7, 1, 'resource_matrix', '', 'https://www.figma.com', NOW(3), NOW(3)),
('resource_matrix', 'tools', 'Wrench', 'Notion', '知识管理与协作平台', '知识管理与协作平台', 8, 1, 'resource_matrix', '', 'https://www.notion.so', NOW(3), NOW(3)),
('resource_matrix', 'tools', 'Wrench', 'Obsidian', '本地知识管理工具', '本地知识管理工具', 9, 1, 'resource_matrix', '', 'https://obsidian.md', NOW(3), NOW(3)),
('resource_matrix', 'tools', 'Wrench', 'Typora', '极简Markdown编辑器', '极简Markdown编辑器', 10, 1, 'resource_matrix', '', 'https://typora.io', NOW(3), NOW(3)),
('resource_matrix', 'tools', 'Wrench', 'Vercel', '前端部署与托管平台', '前端部署与托管平台', 11, 1, 'resource_matrix', '', 'https://vercel.com', NOW(3), NOW(3)),
('resource_matrix', 'tools', 'Wrench', 'Google Fonts', '免费开源字体资源库', '免费开源字体资源库', 12, 1, 'resource_matrix', '', 'https://fonts.google.com', NOW(3), NOW(3)),
...
('friend_links', NULL, 'FileText', '阮一峰的网络日志', '前端技术博客', '前端技术博客', 6, 1, 'friend_links', '', 'https://www.ruanyifeng.com/blog/', NOW(3), NOW(3)),
('friend_links', NULL, 'GraduationCap', 'FreeCodeCamp', '免费编程学习平台', '免费编程学习平台', 7, 1, 'friend_links', '', 'https://www.freecodecamp.org/', NOW(3), NOW(3)),
