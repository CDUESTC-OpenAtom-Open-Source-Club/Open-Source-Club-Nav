...
export default function SurfacePage() {
  const category = RESOURCE_CATEGORIES.find((c) => c.id === "surface");
    ...
    >
      ...
      >
        ...
        >
          ...
          <span>资源导航</span>
          <span style={{ margin: "0 8px" }}>/</span>
          <span style={{ color: "#0f172a", fontWeight: 600 }}>校园</span>
        </nav>
        ...
        >
          <h1
            style={{
              ...
              color: "#0f172a",
              marginBottom: 16,
              background: "linear-gradient(135deg, #06E5CC 0%, #06E5CC 100%)",
          ...
          >
            {category.sublabel} - 教务系统、图书馆、校园卡、就业信息等校园服务
          </p>
        </div>
