...
export default function ArmoryPage() {
  const category = RESOURCE_CATEGORIES.find((c) => c.id === "armory");
    ...
    >
      ...
      >
        ...
        >
          ...
          <span>资源导航</span>
          <span style={{ margin: "0 8px" }}>/</span>
          <span style={{ color: "#0f172a", fontWeight: 600 }}>工具</span>
        </nav>
        ...
        >
          ...
          >
            {category.sublabel} - GitHub、VS Code、Docker、设计工具、文档平台等开发利器
          </p>
        </div>
